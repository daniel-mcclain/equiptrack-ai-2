/*
  # Add Create Admin User Function

  1. Changes
    - Add standalone create_admin_user function for RPC calls
    - Add helper functions for admin user management
    - Maintain existing trigger function
