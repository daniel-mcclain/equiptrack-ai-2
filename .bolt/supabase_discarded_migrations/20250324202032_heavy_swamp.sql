/*
  # Add Inventory Security Integration

  1. Changes
    - Add inventory-specific permissions to role_permissions
    - Add inventory-related resources to security matrix
    - Add default inventory permissions for roles
...
-- Update RLS policies for parts_inventory
