/*
  ...
  2. Security
    ...
    - Checks permissions based on user role and company
*/

-- First drop the existing functions if they exist
DROP FUNCTION IF EXISTS has_permission(UUID, UUID, TEXT, TEXT);
DROP FUNCTION IF EXISTS has_inventory_permission(UUID, UUID, TEXT);
