/*
  # Update locations table migration

  1. Changes
    - Drop existing policies if they exist before creating new ones
    - Keep all other functionality the same
  2. Security
    - Maintain RLS on `locations` table
    - Ensure policies for global admins, company admins, and regular users
    - Preserve audit logging for location changes
*/
