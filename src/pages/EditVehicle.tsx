  ...
  useEffect(() => {
    const fetchVehicleData = async () => {
      try {
        ...
        setFormData({
          ...vehicle,
          last_maintenance: formatDate(vehicle.last_maintenance),
          next_maintenance: formatDate(vehicle.next_maintenance)
        });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/app/vehicles', {
        state: { message: 'Vehicle updated successfully', type: 'success' }
      });
    } catch (err: any) {
